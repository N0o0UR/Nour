...
## Part 1 Cross- Validation for Logistic and linear Regression model:

### The Goal

The goal behind this study is to use the cross-validation method to evaluate the performance of our logistic and linear regression models.
...
The accuracy associated with the model on the training data is 0.9018, that associated with the model in the testing data is 0.9049 and that associated with the model using cross validation is 0.90096. From that we can see that our model is performing good.
