...
---
The data set is shown in the following graph:
...
The data set and the least square line are shown in the following graph:
...
The data, the least square line and the residuals are shown in the following graph:
...
The resulted liner regression model where the values of both $\beta_0$  and $\beta_1$ have been determined and updated is shown below:
...
- Intercept: fishes that are 9 cm long are expected to be 0.87 cm high, on average.
